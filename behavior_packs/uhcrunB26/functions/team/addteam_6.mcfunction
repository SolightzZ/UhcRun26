...
execute as @s[tag=!team6] run particle team6
execute as @s[tag=!team6] run playsound random.orb @a[r=8] ~ ~ ~ 0.4 0.85
execute as @s[tag=team6] run playsound note.bassattack
execute as @s[tag=team6] run title @p title §7คุณได้เลือกทีม §bAqua§7 แล้ว
