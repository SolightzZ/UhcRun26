...
execute as @s[tag=!team5] run particle team5
execute as @s[tag=!team5] run playsound random.orb @a[r=8] ~ ~ ~ 0.4 0.8
execute as @s[tag=team5] run playsound note.bassattack
execute as @s[tag=team5] run title @p title §7คุณได้เลือกทีม §5Purple§7 แล้ว
