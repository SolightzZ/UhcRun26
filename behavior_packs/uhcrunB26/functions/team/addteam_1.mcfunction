...
execute as @s[tag=!team1] run particle team1
execute as @s[tag=!team1] run playsound random.orb @a[r=8] ~ ~ ~ 0.4 0.6
execute as @s[tag=team1] run playsound note.bassattack
execute as @s[tag=team1] run title @p title §7คุณได้เลือกทีม §cRed§7 แล้ว
