...
execute as @s[tag=!team8] run particle team8
execute as @s[tag=!team8] run playsound random.orb @a[r=8] ~ ~ ~ 0.4 0.95
execute as @s[tag=team8] run playsound note.bassattack
execute as @s[tag=team8] run title @p title §7คุณได้เลือกทีม §8Gray§7 แล้ว
